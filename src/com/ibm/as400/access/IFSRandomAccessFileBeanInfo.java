...
//                                                                             
// Filename: IFSRandomAccessFileBeanInfo.java
//                                                                             
...
public class IFSRandomAccessFileBeanInfo extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2004 International Business Machines Corporation and others.";

  private final static Class beanClass = IFSRandomAccessFile.class;
  ...
  static
  {
    try
    {
      ...
      PropertyDescriptor property1 =
        new PropertyDescriptor("existenceOption", beanClass,
                               "getExistenceOption", "setExistenceOption");
      property1.setBound(true);
      property1.setConstrained(true);
      property1.setDisplayName(rbl_.getText("PROP_NAME_EXISTENCE_OPTION"));
      property1.setPropertyEditorClass(IFSExistenceOptionEditor.class);
      property1.setShortDescription(rbl_.getText("PROP_DESC_EXISTENCE_OPTION"));
      PropertyDescriptor property2 =
        new PropertyDescriptor("mode", beanClass, null, "setMode");
      property2.setBound(true);
      property2.setConstrained(true);
      property2.setDisplayName(rbl_.getText("PROP_NAME_MODE"));
      property2.setShortDescription(rbl_.getText("PROP_DESC_MODE"));
      ...
      PropertyDescriptor property6 =
        new PropertyDescriptor("filePointer", beanClass, "getFilePointer",
                               null);
  ...
  public Image getIcon(int icon)
  {
    ...
    case BeanInfo.ICON_COLOR_16x16:
      image = loadImage("IFSRandomAccessFile16.gif");
      break;
    case BeanInfo.ICON_MONO_32x32:
    case BeanInfo.ICON_COLOR_32x32:
      image = loadImage("IFSRandomAccessFile32.gif");
      break;
    }

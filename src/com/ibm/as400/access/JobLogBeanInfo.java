 ...
 **/
public class JobLogBeanInfo extends SimpleBeanInfo
{
    // Class this bean info represents.
    private static final Class BEAN_CLASS = JobLog.class;
    ...
    public Image getIcon(int icon)
    {
        switch (icon)
        {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                return loadImage("JobLog16.gif");

            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                return loadImage("JobLog32.gif");
        }

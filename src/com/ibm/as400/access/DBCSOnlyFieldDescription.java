...
public class DBCSOnlyFieldDescription extends FieldDescription implements VariableLengthFieldDescription, Serializable
{
  ...
  **/
  ...
  /**
   *Constructs a DBCSOnlyFieldDescription object. It uses the specified
   ...
   **/
  public DBCSOnlyFieldDescription(AS400Text dataType, String name)
  {
    super(dataType, name);
  }
   ...
   **/
  public DBCSOnlyFieldDescription(AS400Text dataType, String name, String ddsName)
  {

...
//                                                                             
// Filename: DBCSEitherFieldDescription.java
//                                                                             
 ...
 *It allows:
 *<ul>
 *<li>The user to describe a DBCS-either field to the RecordFormat object.
 *<li>The RecordFormat object to describe a DBCS-either field to the user.
 *</ul>
 *Click <a href="doc-files/recordxmp.html">here</a>to see an example.
**/
public class DBCSEitherFieldDescription extends FieldDescription implements VariableLengthFieldDescription, Serializable
{
  ...
  **/
  ...
  /**
   *Constructs a DBCSEitherFieldDescription object. It uses the specified data type and name
   *of the field.
  ...
  **/
  ...
  /**
   *Constructs a DBCSEitherFieldDescription object. It uses the specified data type, name, 
   *and DDS name of the field.
   *The length of the field will be the length specified on the AS400Text object.
   *@param dataType Describes the field and provides
   *                the conversion capability for the contents of the field.
   *@param name The name of the field.
  ...
  **/
  public DBCSEitherFieldDescription(AS400Text dataType, String name, String ddsName)
  {

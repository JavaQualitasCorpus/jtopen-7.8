 ...
 **/
public class JobListBeanInfo extends SimpleBeanInfo
{
    // Class this bean info represents.
    private static final Class BEAN_CLASS = JobList.class;
    ...
    public Image getIcon(int icon)
    {
        switch (icon)
        {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                return loadImage("JobList16.gif");

            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                return loadImage("JobList32.gif");
        }

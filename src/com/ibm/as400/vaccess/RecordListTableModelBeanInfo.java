...
//                                                                             
// Filename: RecordListTableModelBeanInfo.java
//                                                                             
...
/**
The RecordListTableModelBeanInfo class provides bean
information for the RecordListTableModel class.
@deprecated Use Java Swing instead, along with the classes in package <tt>com.ibm.as400.access</tt>
**/
public class RecordListTableModelBeanInfo extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";


    // Class this bean info represents.
    private final static Class beanClass = RecordListTableModel.class;
    ...
    public Image getIcon(int icon)
    {
        ...
        switch(icon)
        {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage("RecordListTableModel16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage("RecordListTableModel32.gif");
                break;
        }

...
//                                                                             
// Filename: ResourceListModelBeanInfo.java
//                                                                             
...
/**
The ResourceListModelBeanInfo class provides bean information
...
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private final static Class              beanClass_      = ResourceListModel.class;
...
**/
    static
    {
        try {
            ...
            events_ = new EventSetDescriptor[] { error, listData, propertyChange, working };
            ...
            properties_ = new PropertyDescriptor[] { resourceList };
        }
        catch (Exception e) {
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("ResourceListModel16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("ResourceListModel32.gif");
                break;
            default:

...
//                                                                             
// Filename: ResourceListPaneBeanInfo.java
//                                                                             
...
/**
The ResourceListPaneBeanInfo class provides bean information
for the ResourceListPane class.

@see ResourceListPane
@deprecated Use Java Swing instead, along with the classes in package <tt>com.ibm.as400.access</tt>
**/
public class ResourceListPaneBeanInfo
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private final static Class              beanClass_      = ResourceListPane.class;
...
**/
    static
    {
        try {
            ...
            properties_ = new PropertyDescriptor[] { resourceList, resourceProperties, allowActions };
        }
        catch (Exception e) {
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("ResourceListPane16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("ResourceListPane32.gif");
                break;
            default:

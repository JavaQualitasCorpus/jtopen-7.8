...
//                                                                             
// Filename: VSystemValueListBeanInfo.java
//                                                                             
...
/**
The VSystemValueListBeanInfo class provides bean information
...
public class VSystemValueListBeanInfo extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private final static Class              beanClass_      = VSystemValueList.class;
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("VSystemValueList16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("VSystemValueList32.gif");
                break;
        }
        return image;
    }

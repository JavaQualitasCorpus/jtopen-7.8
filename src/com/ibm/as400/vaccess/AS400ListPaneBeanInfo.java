...
//                                                                             
// Filename: AS400ListPaneBeanInfo.java
//                                                                             
...
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private final static Class              beanClass_      = AS400ListPane.class;
...
**/
    static
    {
        try {
            ...
            PropertyDescriptor visibleRowCount = new PropertyDescriptor ("visibleRowCount", beanClass_);
            visibleRowCount.setBound (false);
            visibleRowCount.setConstrained (false);
            visibleRowCount.setDisplayName (ResourceLoader.getText ("PROP_NAME_VISIBLE_ROW_COUNT"));
            visibleRowCount.setShortDescription (ResourceLoader.getText ("PROP_DESC_VISIBLE_ROW_COUNT"));

            properties_ = new PropertyDescriptor[] { allowActions, confirm, model,
                root, selectionModel, visibleRowCount};
        }
        catch (Exception e) {
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("AS400ListPane16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("AS400ListPane32.gif");
                break;
        }
        return image;
    }

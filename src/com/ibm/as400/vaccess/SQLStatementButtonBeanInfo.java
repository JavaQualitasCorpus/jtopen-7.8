...
//                                                                             
// Filename: SQLStatementButtonBeanInfo.java
//                                                                             
...
/**
The SQLStatementButtonBeanInfo class provides bean
information for the SQLStatementButton class.
...
public class SQLStatementButtonBeanInfo extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    private final static Class beanClass = SQLStatementButton.class;

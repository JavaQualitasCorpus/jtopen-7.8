...
//                                                                             
// Filename: VPrintersBeanInfo.java
//                                                                             
...
/**
The VPrintersBeanInfo class provides bean information
...
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private final static Class              beanClass_      = VPrinters.class;
...
**/
    static
    {
        try
        {
            ...
            PropertyDescriptor printerFilter = new PropertyDescriptor("printerFilter", beanClass_);
            printerFilter.setBound(true);
            printerFilter.setConstrained(true);
            printerFilter.setDisplayName(ResourceLoader.getPrintText("PROP_NAME_PRINTERS_PRINTER_FILTER"));
            printerFilter.setShortDescription(ResourceLoader.getPrintText("PROP_DESC_PRINTERS_PRINTER_FILTER"));

            properties_ = new PropertyDescriptor[] {system, printerFilter };
        }
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("VPrinters16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("VPrinters32.gif");
                break;
        }
        return image;
    }

...
//                                                                             
// Filename: CommandCallButtonBeanInfo.java
//                                                                             
...
/**
The CommandCallButtonBeanInfo class provides bean information
for the CommandCallButton class.

@see CommandCallButton
@deprecated Use Java Swing instead, along with the classes in package <tt>com.ibm.as400.access</tt>
**/
public class CommandCallButtonBeanInfo
extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    // Private data.
    private final static Class              beanClass_      = CommandCallButton.class;
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("CommandCallButton16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("CommandCallButton32.gif");
                break;
        }
        return image;
    }

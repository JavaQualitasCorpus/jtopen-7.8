...
//                                                                             
// Filename: HTMLAlignBeanInfo.java
//                                                                             
...
public class HTMLAlignBeanInfo extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    private final static Class beanClass = HTMLAlign.class;
    ...
    static
    {
      ...
      try
      {
        ...
        align.setShortDescription(loader_.getText("PROP_HA_DESC_ALIGN"));
     ...
     * HTMLAlign is a subclass of HTMLTagAttributes, this method

...
//                                                                             
// Filename: UnorderedListBeanInfo.java
//                                                                             
...
/**
The UnorderedListBeanInfo class provides
bean information for the UnorderedList class.
**/
public class UnorderedListBeanInfo extends SimpleBeanInfo
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";


    // Class this bean info represents.
    private final static Class beanClass = UnorderedList.class;
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("UnorderedList16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("UnorderedList32.gif");
                break;
        }
        return image;
    }

...
/**
*  The RecordListRowDataBeanInfo class provides bean information 
*  for the RecordListRowData class.
**/
public class RecordListRowDataBeanInfo extends SimpleBeanInfo
{
    // Class this bean info represents.
    private final static Class beanClass = RecordListRowData.class;
    ...
    {      
      try
      {
        ...
        properties_ = new PropertyDescriptor[] { currentPosition, length, metadata, recordFormat };
      }
      catch (Exception e)
      {
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("RecordListRowData16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("RecordListRowData32.gif");
                break;
        }
        return image;
    }

...
/**
*  The ListMetaDataBeanInfo class provides bean information 
*  for the ListMetaData class.
**/
...
{   
    ...
    {      
      try
      {
        ...
        properties_ = new PropertyDescriptor[] { columnCount };
      }
      catch (Exception e)
      {
    ...
    public Image getIcon (int icon)
    {
        ...
        switch (icon) {
            ...
            case BeanInfo.ICON_COLOR_16x16:
                image = loadImage ("ListMetaData16.gif");
                break;
            case BeanInfo.ICON_MONO_32x32:
            case BeanInfo.ICON_COLOR_32x32:
                image = loadImage ("ListMetaData32.gif");
                break;
        }
        return image;
    }
